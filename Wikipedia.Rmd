...
Whether you’re drawn to its medieval castles, vibrant festivals, or hearty cuisine, Poland offers a rich tapestry of experiences. Join us on a journey through this remarkable country, where tradition meets modernity, and history echoes in every cobblestone street.
...
dfRival %>%
  ...
  ggplot(aes(y = reorder(Rywal, diff))) +
  geom_segment(aes(
    x = GZ,
    xend = GS,
